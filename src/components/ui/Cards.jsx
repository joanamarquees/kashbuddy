...
export const FinancialCard = ({ transactions, accounts }) => {
	...
	return (
		<div className="relative mx-auto w-full md:w-[353px] h-60 mb-5 items-center">
			{/* Background Layer 1 */}
			<div className="absolute w-[90%] h-[208px] top-0 left-4 bg-slate-700 rounded-[22px]"></div>

			{/* Background Layer 2 */}
			<div className="absolute w-[95%] h-[208px] bottom-0 left-2 bg-slate-400 rounded-[22px]"></div>

			{/* Total Balance Section */}
			<div className="absolute top-14 left-0 right-0 flex flex-col items-center">
				<h2 className="text-zinc-100 font-sans font-semibold text-lg">
					Total Balance
				</h2>
				<p className="text-zinc-100 font-sans font-extrabold text-4xl">
					{" "}
					{totalNetworth} €
				</p>
			</div>
			...
			<div className="absolute w-full flex justify-between items-center top-40 px-10">
				...
				<div className="flex items-center space-x-2">
					...
					<div>
						...
						<p className="text-zinc-100 text-sm font-extrabold">
							{" "}
							-{totalExpenses} €
						</p>
					</div>
