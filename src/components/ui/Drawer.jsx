		...
		<AnimatePresence>
			{contentId !== null && (
				<>
					...
					{/* drawer */}
					<motion.div
						className="fixed -bottom-20 inset-x-0 mx-auto w-full min-h-50 max-h-screen bg-light-background rounded-t-7xl overflow-y-auto z-50"
						initial={{ y: 336 }}
						animate={{ y: 0 }}
						exit={{ y: 500 }}
						...
						onDragEnd={(_, { offset, velocity }) => {
							...
							if (offset.y >= window.innerHeight * 0.2 || velocity.y >= 100) {
								setDrawerState(null);
							}
						}}
					>
						{/* drawer tip */}
						<button type="button" className="my-3 mx-auto flex justify-center">
							<motion.div
